...
FOAM_FILES([
  ...
  { name: "foam/nanos/bench/BenchmarkResultReportingDAO" },
  { name: "foam/nanos/bench/BenchmarkResultSystemDAO" },
  ...
  { name: 'foam/nanos/medusa/AnnouncePrimaryDAO' },
  { name: 'foam/nanos/medusa/BlockingDAO' },
  ...
  { name: 'foam/nanos/medusa/MedusaEntrySupport' },
  { name: 'foam/nanos/medusa/MedusaEntryTimeoutException' },
  ...
  { name: 'foam/nanos/medusa/MultiplePrimariesException' },
  { name: 'foam/nanos/medusa/NodeCView' },
  { name: 'foam/nanos/medusa/PrimaryMediatorDAO' },
  ...
  { name: 'foam/nanos/medusa/RenouncePrimaryDAO' },
  ...
  { name: 'foam/nanos/medusa/benchmark/MedusaTestBenchmark' },
  ...
  { name: "foam/nanos/ruler/RuleActionMergeDecorator" },
